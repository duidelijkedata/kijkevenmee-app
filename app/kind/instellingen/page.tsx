...
export default function Instellingen() {
  ...
  Als dit <b>aan</b> staat, dan moet de ouder de 6-cijferige code handmatig
  doorgeven en jij vult hem in bij <b>Verbinden</b>.
  <br />
  Als dit <b>uit</b> staat, dan kunnen gekoppelde ouders een hulpsessie starten{" "}
  <b>zonder</b> dat jij een code hoeft over te typen (je ziet dan automatisch
  een “actieve sessie” bij <b>Verbinden</b>).
</p>
                </div>
              </div>
            </div>
