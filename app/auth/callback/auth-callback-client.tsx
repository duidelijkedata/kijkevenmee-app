  ...
  useEffect(() => {
    const run = async () => {
      try {
        ...
        // ✅ PKCE flow: Supabase magic link komt vaak terug met ?code=...
        const code = sp.get("code");

        // (optioneel) legacy flows in hash
        ...
        // URL opschonen (voorkomt dubbele verwerking bij refresh)
        ...
        router.replace(`/kind/login?error=callback_failed`);
      }
    };
